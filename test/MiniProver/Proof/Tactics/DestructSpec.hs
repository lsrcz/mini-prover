...
spec =
  describe "destruct" $ do
    ...
    it "eq m -- goal" $ 
      ...
      [ Goal 2 ([("~m",VarBind (TmIndType "nat" [])), ("n",VarBind (TmIndType "nat" []))]++realPlusContext)
        ( TmIndType "eq"
          [ TmIndType "nat" []
          , TmAppl
            [ TmRel "plus" 2
          ...
          , TmAppl
            ...
            , TmRel "n" 1
            , TmConstr "O" [] ]])
      , Goal 3 (("n0",VarBind (TmIndType "nat" [])):("~m",VarBind (TmIndType "nat" [])):("n",VarBind (TmIndType "nat" [])):realPlusContext)
        ( TmIndType "eq"
          [ TmIndType "nat" []
          , TmAppl
            [ TmRel "plus" 3
